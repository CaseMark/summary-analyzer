...
2. **Page/Line Reference Accuracy** (20% weight) - VERIFY AGAINST SOURCE
   - Are page and line citations correct when checked against SOURCE?
   - Are citations formatted consistently?
   - Do the citations actually point to the correct content in SOURCE?

3. **Relevance** (20% weight) - BASED ON SOURCE CONTENT
   - Does the summary focus on legally significant information from SOURCE?
   - Are irrelevant details minimized?
   - Does it capture what matters for the case type?

4. **Comprehensiveness** (15% weight) - COVERAGE OF SOURCE
   - Does it cover all major topics from the SOURCE?
...
Respond with a JSON object in this exact format:
{
    ...
    "page_line_accuracy": {
        "score": <0-100>,
        "rationale": "Are TEST citations correct when verified against SOURCE?",
        "examples": ["Correct citation to SOURCE...", "Incorrect: cites page X but content is on page Y..."]
    },
    "relevance": {
        "score": <0-100>,
    ...
    "legal_utility": {
        "score": <0-100>,
        "rationale": "How useful is this for legal professionals?",
        "examples": ["Useful feature...", "Missing practical element..."]
    },
    "overall_score": <0-100>,
    ...
    "specific_errors": [
        {
            ...
            "source_reference": "What SOURCE actually says (page/line if applicable)",
            "explanation": "Why this is an error vs SOURCE",
    ...
    "analysis_notes": "Overall assessment of TEST accuracy to SOURCE",
    "recommendation": "Recommendation for using this model (considering both quality and how it compares to current production)"
}`;
